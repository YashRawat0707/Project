  ...
  return (
    <div className='w-full grid grid-cols-2 gap-x-6 mt-5'>
      <div className='bg-white gap-x-3 p-6 rounded flex justify-center  items-center'>
        <div>
          <label htmlFor="img" className={`w-[150px] h-[150px] flex  rounded text-[#404040] gap-2 justify-center border-2 items-center cursor-pointer border border-dashed`}>
        ...
        <div className='text-[#404040] flex flex-col gap-y-1 justify-center items-start'>
          <span>Name : Swayam Sharma</span>
          <span>Email : swayamsonak@gmail.com</span>
